...
export function Info() {
  return (
    <Wrapper>
      <div
        id="info"
        className="-mt-28 flex flex-col items-center gap-8 rounded-md border border-zinc-300 bg-rose-100 py-12 text-center lg:flex-row lg:justify-evenly lg:py-16"
      >
